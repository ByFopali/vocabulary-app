...
from api.crud.word_crud import create_word, get_all_words, update_word, delete_the_word
from api.dependencies import (
    if_word_exists_and_auth_for_specific_topic,
    word_by_id,
    verify_topic_ownership,
)
from api.schemas.word_schemas import WordCreate, Word, WordUpdatePartial
from auth.utils import get_current_user, get_current_auth_user_model
from src.models import db_helper, TopicWordAssociation, User
